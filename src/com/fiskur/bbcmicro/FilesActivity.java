...
public class FilesActivity extends Activity {
		...
		mFilenameEdit.setOnEditorActionListener(new OnEditorActionListener() {
			...
			public boolean onEditorAction(TextView arg0, int action, KeyEvent arg2) {
				...
				if (mContent != null) {
					...
					FilesActivity.this.setResult(RESULT_FILES_ACTIVITY, filenameIntent);
	...
	private void showError(String error) {
		Toast.makeText(FilesActivity.this, error, Toast.LENGTH_LONG).show();
	}
	...
	private class OpenFile extends AsyncTask<String, String, String> {
		...
		protected void onPostExecute(String result) {
			...
			if (error) {
				...
				FilesActivity.this.setResult(RESULT_FILES_ACTIVITY, contentIntent);
				FilesActivity.this.finish();
			}
